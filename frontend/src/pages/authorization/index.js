                ...
                <div className="u-align-center u-container-style u-group u-shape-rectangle u-white u-group-1">
                    <div className="u-container-layout u-container-layout-1">
                        ...
                        <div style={{paddingTop:"35px"}}>
                            <a href={vk_url}>
                                <span className="u-icon u-icon-circle u-text-palette-1-base u-icon-1"><svg
                                className="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 112.196 112.196"
                            ><use xmlnsXlink="http://www.w3.org/1999/xlink" xlinkHref="#svg-b8a8"/></svg><svg
                                className="u-svg-content" viewBox="0 0 112.196 112.196" x="0px" y="0px" id="svg-b8a8"
                                style={{enableBackground: 'new 0 0 112.196 112.196'}}><g><g><circle id="XMLID_11_"
                                                                                                    style={{fill: "currentColor"}}
                                                                                                    cx="56.098" cy="56.098"
                                                                                                    r="56.098"/>
    </g><path style={{fillRule: "evenodd", clipRule: "evenodd", fill: "#FFFFFF"}}
